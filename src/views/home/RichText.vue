...
import './assets/style.css' // 引入 css
...
<template>
  <div v-show="UI.show" style="width: 80%;height: 90%;left: 10%;top: 5%;position: fixed;background-color: white;z-index: 999;border-radius: 12px;
